...
namespace JobConfiguration.Services
{
    public class DataService
    {
         ...
         *  </configuration>
         *
         *  The production url is:  https://datastation.shs.org/api/Database
         *  The test url is:        http://sphpwebpvws01.shs.org:665/api/Database
         *
        ...
        public enum DataBase { PhpConfg, PhpStaging, PhpArchv, ClinicalWebDb, LawsonCustom }
